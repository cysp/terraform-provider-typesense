...
CI tests Terraform **1.15 and 1.16** with Typesense **29.1 and 30.2**. This provider release targets Typesense **30.2**; the 29.1 runs provide compatibility coverage without a support promise.
